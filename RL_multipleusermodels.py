...
def simulate(ALPHA, GAMMA, num_interactions, egreedy_param, num_episodes, user_model):
  ...
  #  start_state = [0, 1, 0, 0, 0]
    ...
    if q:
        ins = open("q_table_usm1_r-5_200", 'r')
...
# =============================================================================
#     if user_model == 1:
#         with open('q_table_user_model1_r-5', 'w') as f:
#             writer = csv.writer(f, delimiter=' ')
#             writer.writerows(Q)
#     if user_model ==2:
#          with open('q_table_user_model2_r-5', 'w') as f:
#              writer = csv.writer(f,delimiter=' ')
#              writer.writerows(Q)
#     if user_model ==3:
#          with open('q_table_user_model3_r-5', 'w') as f:
#              writer = csv.writer(f,delimiter=' ')
#              writer.writerows(Q)
#     if user_model ==4:
#          with open('q_table_user_model4_r-5', 'w') as f:
#              writer = csv.writer(f,delimiter=' ')
#              writer.writerows(Q)
# =============================================================================
