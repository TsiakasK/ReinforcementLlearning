...
def simulate(ALPHA, GAMMA, num_interactions, egreedy_param, num_episodes, user_model):
    ...
    start_pain = np.random.choice([0, 1])
...
run1_returns, run1_errors = simulate(ALPHA=0.5, GAMMA=0.9, num_interactions= 180, egreedy_param=0.1, num_episodes=1, user_model=1)
run2_returns, run2_errors = simulate(ALPHA=0.5, GAMMA=0.9, num_interactions= 180, egreedy_param=0.1, num_episodes=1, user_model=2)
run3_returns, run3_errors = simulate(ALPHA=0.5, GAMMA=0.9, num_interactions= 180, egreedy_param=0.1, num_episodes=1, user_model=3)
run4_returns, run4_errors = simulate(ALPHA=0.5, GAMMA=0.9, num_interactions= 180, egreedy_param=0.1, num_episodes=1, user_model=4)
