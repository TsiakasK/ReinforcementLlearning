# -*- coding: utf-8 -*-
"""
Created on Mon Oct  9 11:08:55 2023
...
# using -1 for switching state resulted in a policy that never changed state
    ...
    elif (action == previous_action and next_state[2] == 0):
        score -= 1
    else:
        score = 0
...
def simulate(ALPHA, GAMMA, num_interactions, egreedy_param, num_episodes):
    ...
    interactions = num_interactions        # this can change to suit the problem -- number of rounds
    attempts = []
    errors = []
    returns = []
...
# =============================================================================
# run1_returns, run1_errors = simulate(ALPHA=0.1, GAMMA=0.9, num_interactions= 50, egreedy_param=0.96, num_episodes=200)
# run2_returns, run2_errors = simulate(ALPHA=0.1, GAMMA=0.9, num_interactions= 50, egreedy_param=0.97, num_episodes=200)
# run3_returns, run3_errors = simulate(ALPHA=0.1, GAMMA=0.9, num_interactions= 50, egreedy_param=0.98, num_episodes=200)
# run4_returns, run4_errors = simulate(ALPHA=0.1, GAMMA=0.9, num_interactions= 50, egreedy_param=0.99, num_episodes=200)
# 
...
# plt.legend(['epsilon_param=0.96','epsilon_param=0.97', 'epsilon_param=0.98', 'epsilon_param=0.99'])
...
# =============================================================================
# run1_returns, run1_errors = simulate(ALPHA=0.01, GAMMA=0.9, num_interactions= 50, egreedy_param=0.97, num_episodes=200)
# run2_returns, run2_errors = simulate(ALPHA=0.05, GAMMA=0.9, num_interactions= 50, egreedy_param=0.97, num_episodes=200)
# run3_returns, run3_errors = simulate(ALPHA=0.1, GAMMA=0.9, num_interactions= 50, egreedy_param=0.97, num_episodes=200)
# run4_returns, run4_errors = simulate(ALPHA=0.2, GAMMA=0.9, num_interactions= 50, egreedy_param=0.97, num_episodes=200)
# 
# plt.plot(moving_average(run1_returns), 'b', moving_average(run2_returns), 'r', moving_average(run3_returns), 'g', moving_average(run4_returns), 'c')
# plt.legend(['alpha=0.01', 'alpha=0.05','alpha=0.1','alpha=0.2'])
# plt.title("Total return")
# plt.show()
# 
# plt.plot(moving_average(run1_errors), 'b', moving_average(run2_errors), 'r', moving_average(run3_errors), 'g', moving_average(run4_errors), 'c')
...
# =============================================================================
# run1_returns, run1_errors = simulate(ALPHA=0.1, GAMMA=0.7, num_interactions= 50, egreedy_param=0.97, num_episodes=200)
# run2_returns, run2_errors = simulate(ALPHA=0.1, GAMMA=0.8, num_interactions= 50, egreedy_param=0.97, num_episodes=200)
# run3_returns, run3_errors = simulate(ALPHA=0.1, GAMMA=0.9, num_interactions= 50, egreedy_param=0.97, num_episodes=200)
# run4_returns, run4_errors = simulate(ALPHA=0.1, GAMMA=0.99, num_interactions= 50, egreedy_param=0.97, num_episodes=200)
# 
# plt.plot(moving_average(run1_returns), 'b', moving_average(run2_returns), 'r', moving_average(run3_returns), 'g', moving_average(run4_returns), 'c')
# plt.legend(['gamma=0.7', 'gamma=0.8','gamma=0.9','gamma=0.99'])
# plt.title("Total return")
# plt.show()
# 
# plt.plot(moving_average(run1_errors), 'b', moving_average(run2_errors), 'r', moving_average(run3_errors), 'g', moving_average(run4_errors), 'c')
